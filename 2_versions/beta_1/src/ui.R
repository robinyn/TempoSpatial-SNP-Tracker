                                            ...
                                            fluidRow(
                                              column(width=9,
                                                radioButtons("grouping_var", "Grouping variable", choices = c("None", "Country", "Distance"), 
                                                             ...
                                                             style='padding-left:10px; padding-right:0px; padding-top:0px; padding-bottom:0px;'
                                              ),
                                              column(width=3,
                                                     prettySwitch(inputId = "showlabel", label="Labels"),
                                                     style='padding-left:1px; padding-right:50px; padding-top:26px; padding-bottom:0px;'
                                              )
                                            ), # /fluid row
                                            conditionalPanel(
